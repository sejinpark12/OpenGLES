//
// Created by Daemyung Jang on 2021/10/15.
//
...
int main([[maybe_unused]] int argc, [[maybe_unused]] char *argv[]) {
    App app{};
    Window window{{.title = "Element 배우기", .size = {1280, 720}}};
    ...
    window.run([&app, &window] {
                   ...
                   app.program = create_graphics_pipeline({home() / "15.LearnElement/res/triangle.vert",
                                                           home() / "15.LearnElement/res/unlit.frag"});
               },
               [] {},
               [&app, &window] {
